...
def train_model(args, model, criterion, dataloaders, dataset_sizes, optimizer, scheduler, num_epochs=25):
...
#     }
    ...
    '''
    model_ft = train_model(args, model_ft, criterion, dataloaders, dataset_sizes, optimizer, scheduler, num_epochs=args.epoch)
